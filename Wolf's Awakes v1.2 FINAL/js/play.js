var playState = {
   ...
   //var y = game.world.randomY;
    ...
    enemigosVivos = 30;
        ...
        this.follower = game.add.sprite(-900, 400, 'follower');
...
//    }
 ...
 var Monedita_y = [1430,1430,1430,1430,1430,1430,1430,1430,1430,1430,1430,1430,1430,1430,1430,1430,1430,1430,1400,1385,1375,1430,1430,1430,1430,1430,1430,1430,1430,1430,1405,1430,1430,1430,1430,1430,1430,1430,1430,1430,1430,1333,1333,1333,1333,1333,
    ...
    playerWin: function() {
        ...
        this.game.world.remove(this.muerteLabel);
		this.victoriaLabel = game.add.text(350, 200, 'Has Escapado!', { font: '60px Arial', fill: '#ffffff' });
	...
	playerDie: function() {
       ...
       this.game.world.remove(this.victoriaLabel);
